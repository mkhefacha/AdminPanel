    ...
    <tr data-entry-id="{{$companie_liste->id}}">
        ...
        <td>
            @can('liste_company_show')
                ...
                <button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#exampleModal{{$companie_liste->id}}" data-whatever="@getbootstrap">afficher</button>
