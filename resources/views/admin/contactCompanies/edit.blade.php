                        ...
                        <form action="{{ route("admin.contact-companies.update", $contactCompany->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group {{ $errors->has('company_name') ? 'has-error' : '' }}">
                                ...
                                <input type="text" id="company_name" name="company_name" class="form-control"
                                       value="{{ old('company_name', isset($contactCompany) ? $contactCompany->company_name : '') }}">
                            ...
                            <div class="form-group {{ $errors->has('company_address') ? 'has-error' : '' }}">
                                ...
                                <input type="text" id="company_address" name="company_address" class="form-control"
                                       value="{{ old('company_address', isset($contactCompany) ? $contactCompany->company_address : '') }}">
                            ...
                            <div class="form-group {{ $errors->has('company_website') ? 'has-error' : '' }}">
                                ...
                                <input type="text" id="company_website" name="company_website" class="form-control"
                                       value="{{ old('company_website', isset($contactCompany) ? $contactCompany->company_website : '') }}">
                            ...
                            <div class="form-group {{ $errors->has('company_email') ? 'has-error' : '' }}">
                                ...
                                <input type="text" id="company_email" name="company_email" class="form-control"
                                       value="{{$contactCompany->company_email}}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control">
                                    ...
                                    <option value="1" {{$contactCompany->status=='Active' ? 'selected':''}}>Actif</option>
